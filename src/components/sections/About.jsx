...
export const About = () => {
  const skills = ["Java", "C", "C#", "Python", "JavaScript"];
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="rounded-xl p-8 border-black/10 border hover:-translate-y-1 transition-all">
            <p className="text-black mb-6">
              Passionate developer from Galicia, Spain. Actually studying Computer Engineering at
              UDC, in the specialization of Software Engineering. I have experience with different
              technologies, languages and frameworks, including Java, C, C#, Python and JavaScript.
              I'm always eager to learn new things and take on new challenges, and I'm excited to
              continue growing as a developer and making an impact in the tech industry.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="text-black p-6 rounded-xl border-black/10 border hover:-translate-y-1 transition-all">
              ...
              <ul className="list-disc list-inside space-y-2">
                <li>
                  <strong>Bachelor's Degree in Computer Engineering</strong> - University of A
                  Coruña (UDC), Spain (2022 - Present)
                </li>
                <li>
